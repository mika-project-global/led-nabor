/*
  # Fix warranty pricing with exact values
  
  1. Changes
    - Set exact values for warranty pricing in all currencies
    - Create a function to return exact values without calculation
    - Ensure Ukrainian currency shows exactly 1450 UAH
*/
