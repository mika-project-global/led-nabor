      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center space-y-6">
              ...
              <div className="pt-4">
                <a
                  href="#kits"
                  className="inline-flex items-center gap-2 bg-cyan-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-cyan-600 transition-all transform hover:scale-105 shadow-lg"
                >
        ...
        <section className="py-10 md:py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-xl p-5 md:p-8 lg:p-12 border border-gray-100">
        ...
        {/* Our Kits Section */}
        <section id="kits" className="py-10 md:py-16 px-4 bg-gray-50">
                ...
                <div key={product.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all transform hover:-translate-y-1">
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-2 bg-gray-900 text-white px-6 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-colors w-full justify-center"
                    >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {galleryImages.map((image, index) => (
                <div
                  key={index}
                  className="relative h-80 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow group"
                >
                  <img
                    src={image.url}
                    alt={image.title}
        ...
        {/* Installation Steps */}
        <section className="py-10 md:py-16 px-4 bg-gradient-to-br from-cyan-50 to-blue-50">
              ...
              {installationSteps.map((step) => (
                <div key={step.number} className="relative">
                  <div className="bg-white rounded-2xl p-8 shadow-lg h-full">
                    <div className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mb-6 mx-auto">
                      {step.number}
                    </div>
        ...
        {/* CTA Section */}
        <section className="py-10 md:py-16 px-4 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a
              href="#kits"
              className="inline-flex items-center gap-2 bg-white text-gray-900 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-all transform hover:scale-105 shadow-lg"
            >
              {t('led_ceiling_kit.hero_cta')}
              <ChevronRight className="w-5 h-5" />
            </a>
        ...
        <section className="py-8 md:py-12 px-4 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-6 text-center">
              ...
              >
                <h3 className="font-semibold text-gray-900 mb-2">{t('menu.installation_guide')}</h3>
              ...
              <Link
                ...
                className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow"
              >
                <h3 className="font-semibold text-gray-900 mb-2">{t('menu.blog')}</h3>
              ...
              <Link
                ...
                className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow"
              >
                <h3 className="font-semibold text-gray-900 mb-2">{t('menu.support')}</h3>
