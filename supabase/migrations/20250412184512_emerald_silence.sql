/*
  ...
  1. Changes
    - Create improved function to get warranty prices for specific variants
    - Create function to update warranty prices with proper variant handling
    - Ensure prices are correctly scaled based on variant length
...
-- Create function to get all warranty prices for admin panel with variant support
...
-- Create function to get warranty prices for admin panel with variant filter
