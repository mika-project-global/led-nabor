...
async function generateSitemap() {
  ...
  const staticPages = [
    ...
    { path: 'led-ceiling-lighting-bedroom/', priority: '0.9', freq: 'weekly' },
    { path: 'led-ceiling-lighting-kitchen/', priority: '0.9', freq: 'weekly' },
    { path: 'led-ceiling-lighting-living-room/', priority: '0.8', freq: 'weekly' },
    { path: 'led-ceiling-lighting-bathroom/', priority: '0.8', freq: 'weekly' },
    { path: 'led-ceiling-lighting-office/', priority: '0.8', freq: 'weekly' },
    { path: 'led-ceiling-lighting-hallway/', priority: '0.8', freq: 'weekly' },
