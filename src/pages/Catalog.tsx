            ...
            >
              <div className="relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 md:p-5 text-white z-20">
                  <h3
                    className="heading-h2 mb-2 group-hover:translate-y-[-5px] transition-transform"
                    style={{ color: '#ffffff', textShadow: '0 3px 20px rgba(0,0,0,0.7), 0 1px 4px rgba(0,0,0,0.5)' }}
                  >
                    {t(`categories.${category.id}.name`)}
                  </h3>
                  <p
                    className="text-base md:text-lg group-hover:translate-y-[-5px] transition-transform delay-75"
                    style={{ color: '#ffffff', textShadow: '0 3px 20px rgba(0,0,0,0.7), 0 1px 4px rgba(0,0,0,0.5)' }}
                  >
          ...
          <div className="prose-container-wide">
            ...
            <div className="text-center">
              ...
              >
                ...
                {t('home_seo.read_full_guide')}
              </Link>
              <p className="text-sm text-gray-500 mt-3">
                {t('home_seo.read_full_guide_subtitle')}
              </p>
            </div>
