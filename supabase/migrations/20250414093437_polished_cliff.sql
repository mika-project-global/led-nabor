...
-- Создаем функцию для получения цен гарантии для конкретного варианта
...
-- Создаем функцию для обновления цены гарантии для конкретного варианта
...
-- Обновляем функцию для получения цены гарантии для конкретного варианта
