...
export default function LedCeilingLightingKitchen() {
  ...
  const faqItems = [
    ...
    { question: t('kitchen_lighting.faq.q6.question'), answer: t('kitchen_lighting.faq.q6.answer') },
    { question: t('kitchen_lighting.faq.q7.question'), answer: t('kitchen_lighting.faq.q7.answer') },
    { question: t('kitchen_lighting.faq.q8.question'), answer: t('kitchen_lighting.faq.q8.answer') },
    { question: t('kitchen_lighting.faq.q9.question'), answer: t('kitchen_lighting.faq.q9.answer') }
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-12 md:py-16 bg-white border-t border-gray-100">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
              {t('kitchen_lighting.seo_guide.title')}
            </h2>
            <div className="space-y-4 text-gray-700 leading-relaxed text-base md:text-lg">
              <p>{t('kitchen_lighting.seo_guide.p1')}</p>
              <p dangerouslySetInnerHTML={{ __html: t('kitchen_lighting.seo_guide.p2') }} />
              <p dangerouslySetInnerHTML={{ __html: t('kitchen_lighting.seo_guide.p3') }} />
              <p dangerouslySetInnerHTML={{ __html: t('kitchen_lighting.seo_guide.p4') }} />
              <p dangerouslySetInnerHTML={{ __html: t('kitchen_lighting.seo_guide.p5') }} />
              <p dangerouslySetInnerHTML={{ __html: t('kitchen_lighting.seo_guide.p6') }} />
            </div>
          </div>
        </section>
