  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-5 md:py-8">
      ...
      <div className="text-center mb-12">
        <h1 className="heading-h1 mb-4">{t('about.title')}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
        <div className="bg-white p-6 rounded-lg shadow-lg text-center">
          ...
          <h3 className="heading-h4 mb-2">{t('about.stats.customers')}</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg text-center">
          ...
          <h3 className="heading-h4 mb-2">{t('about.stats.experience')}</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg text-center">
          ...
          <h3 className="heading-h4 mb-2">{t('about.stats.quality')}</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg text-center">
          ...
          <h3 className="heading-h4 mb-2">{t('about.stats.warranty')}</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        <div>
          <h2 className="heading-h2 mb-6">{t('about.how_we_work')}</h2>
          <div className="space-y-6 text-body">
            <p>
              {t('about.how_we_work_desc')}
            </p>
            <div className="bg-cyan-50 p-6 rounded-lg">
              <h3 className="heading-h4 mb-4 flex items-center gap-2">
        ...
        <div>
          <h2 className="heading-h2 mb-6">{t('about.advantages')}</h2>
          <div className="space-y-6 text-body">
            <div>
              <h3 className="heading-h4 mb-2">{t('about.advantage_1_title')}</h3>
              <p>
                {t('about.advantage_1_desc')}
              </p>
            </div>
            <div>
              <h3 className="heading-h4 mb-2">{t('about.advantage_2_title')}</h3>
              <p>
                {t('about.advantage_2_desc')}
              </p>
            </div>
            <div>
              <h3 className="heading-h4 mb-2">{t('about.advantage_3_title')}</h3>
              <p>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="heading-h2 mb-6">{t('about.contact_info')}</h2>
