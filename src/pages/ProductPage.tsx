      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-6">
        ...
        <div className="space-y-4 md:space-y-5">
          <div className="product-card">
            <div className="relative aspect-[282/198] lg:aspect-[282/198] mb-3 lg:mb-4 bg-gray-100 rounded-lg overflow-hidden">
              {(() => {
                const currentMedia = product.images && product.images.length > 0
                  ? product.images[selectedImage]
                  : product.image;
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            {product.id === 1 && (
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-full">
