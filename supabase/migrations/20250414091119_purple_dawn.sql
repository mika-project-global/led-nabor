/*
  # Fix warranty price scaling for different product lengths
  ...
  1. Changes
    ...
    - Update the get_warranty_price_for_variant function to correctly handle all variants
...
-- Update the client-side price-utils.ts function to properly handle variant-specific warranty prices
CREATE OR REPLACE FUNCTION get_warranty_price(
  p_product_id integer,
  p_months integer,
  p_currency text DEFAULT 'CZK',
