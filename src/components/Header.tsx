...
import { ShoppingCart as CartIcon, Menu, LogIn, HelpCircle, PenTool, Users, Headphones as HeadphonesIcon, Shield, BookOpen, Lightbulb, ArrowLeftRight } from 'lucide-react';
...
export function Header() {
  ...
  const dropdownItems = [
    ...
    { path: `/${locale}/comparison`, icon: ArrowLeftRight, label: t('comparison.title', 'Compare kits') },
