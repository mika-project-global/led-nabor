/*
  ...
  1. Changes
    - Fix the issue where price changes in admin panel don't reflect on the website
    - Add better synchronization between product_prices and products tables
    - Set the 10-meter RGB+CCT product price to 9900 CZK
    - Add verification to ensure prices are correctly saved
*/
